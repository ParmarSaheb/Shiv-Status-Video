...
class LikedPrefs {
  ...
  static Future<void> setLikedImageList(dynamic list) async => await sp?.setStringList(LikedPrefsKey.likedImageList.name, (list as List<GetLikePhotosData>).map((e) => jsonEncode(e)).toList() as List<String>);
